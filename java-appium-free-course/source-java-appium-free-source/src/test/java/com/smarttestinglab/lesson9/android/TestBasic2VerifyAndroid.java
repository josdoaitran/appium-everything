...
public class TestBasic2VerifyAndroid {
    ...
    public void testBasicTapSendKey() {
        ...
        loginButton.click();
        menuIcon.click();
        WebElement logoutOptionMenu = driver.findElement(AppiumBy.accessibilityId("Login Menu Item"));
        Assert.assertTrue(logoutOptionMenu.isDisplayed());
    }
}
